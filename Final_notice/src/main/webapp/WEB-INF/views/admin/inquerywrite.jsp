...
<jsp:include page="/WEB-INF/views/include/header.jsp"/>
	...
	<form action="inqueryadd" method="post" enctype="multipart/form-data" name="noticeform">
			...
			<div class="col-sm-9 align-items-center">
				<table class="table table-bordered ">
					...
					<tr>
						...
						<td><input name="inquery_subject" id="subject" type="text" class="form-control"></td>
					</tr>
					<tr>
